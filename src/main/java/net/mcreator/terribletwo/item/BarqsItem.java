...
import net.mcreator.terribletwo.procedures.BarqsPlayerFinishesUsingItemProcedure;
...
public class BarqsItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("It's got that bite."));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		BarqsPlayerFinishesUsingItemProcedure.execute(world, entity);
		return retval;
	}
}
