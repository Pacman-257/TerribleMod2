...
public class SpringtrapRenderer extends HumanoidMobRenderer<SpringtrapEntity, HumanoidModel<SpringtrapEntity>> {
	...
	public ResourceLocation getTextureLocation(SpringtrapEntity entity) {
		return new ResourceLocation("terribletwo:textures/entities/springtrap.png");
	}
}
