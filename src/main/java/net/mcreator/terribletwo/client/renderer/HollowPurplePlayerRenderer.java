...
public class HollowPurplePlayerRenderer extends EntityRenderer<HollowPurplePlayerEntity> {
	...
	public HollowPurplePlayerRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelhollowpurple(context.bakeLayer(Modelhollowpurple.LAYER_LOCATION));
	}

	@Override
	public void render(HollowPurplePlayerEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(HollowPurplePlayerEntity entity) {
		return texture;
	}
}
