...
public class SantaRenderer extends HumanoidMobRenderer<SantaEntity, HumanoidModel<SantaEntity>> {
	...
	@Override
	protected void scale(SantaEntity entity, PoseStack poseStack, float f) {
		poseStack.scale(3f, 3f, 3f);
	}

	@Override
	public ResourceLocation getTextureLocation(SantaEntity entity) {
