...
public class ShiaLoreProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		TerribletwoMod.queueServerWork(140, () -> {
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal("\u00A7oShia LaBeouf alongside LowTierGod reigned in heaven for all recorded history."), false);
		});
		...
		TerribletwoMod.queueServerWork(1340, () -> {
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal("\u00A7oTo my knowledge he still is trapped there to this very day"), false);
		});
		TerribletwoMod.queueServerWork(1440, () -> {
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal("\u00A7oHowever... Traces of his power remain throughout the world in its dark corner. "), false);
		});
		TerribletwoMod.queueServerWork(1540, () -> {
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal("\u00A7oHis puppets, the vessels, still emerge from time to time to carry out his will."), false);
		});
		TerribletwoMod.queueServerWork(1640, () -> {
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal("\u00A7oThe death of LowTierGod."), false);
		});
		TerribletwoMod.queueServerWork(1740, () -> {
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal("\u00A7oYour goal is the same as the vessels as you are in part one, but I believe that you are far more than just a vessel."), false);
		});
	}
}
