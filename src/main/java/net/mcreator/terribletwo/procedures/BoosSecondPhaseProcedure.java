...
@EventBusSubscriber
public class BoosSecondPhaseProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof BoosEntity) {
			if (!entity.getPersistentData().getBoolean("CanDie")) {
				...
				}
				{
					...
					if (!_ent.level().isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
								_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), "attribute @s minecraft:generic.attack_damage base set 0");
					}
				}
				{
					Entity _ent = entity;
					if (!_ent.level().isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
								_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), "attribute @s minecraft:generic.movement_speed base set 0.01");
					}
				}
				{
					Entity _ent = entity;
				...
				if (!entity.getPersistentData().getBoolean("Phase")) {
					if (!(entity.getPersistentData().getString("State")).equals("Fracture")) {
						...
						entity.getPersistentData().putString("State", "Fracture");
					}
				} else if (!(entity.getPersistentData().getString("State")).equals("Disperse")) {
					entity.getPersistentData().putDouble("IA", 0);
					entity.getPersistentData().putString("State", "Disperse");
				}
			}
		}
	}
