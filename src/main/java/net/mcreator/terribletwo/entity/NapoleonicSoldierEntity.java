...
public class NapoleonicSoldierEntity extends Monster implements RangedAttackMob {
	public NapoleonicSoldierEntity(EntityType<NapoleonicSoldierEntity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
	...
	public static void init(SpawnPlacementRegisterEvent event) {
		event.register(TerribletwoModEntities.NAPOLEONIC_SOLDIER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
