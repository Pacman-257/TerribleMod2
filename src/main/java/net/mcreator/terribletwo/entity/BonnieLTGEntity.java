...
public class BonnieLTGEntity extends Monster implements RangedAttackMob {
	public BonnieLTGEntity(EntityType<BonnieLTGEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		JumpscareBonnieEntity.shoot(this, target);
	}
