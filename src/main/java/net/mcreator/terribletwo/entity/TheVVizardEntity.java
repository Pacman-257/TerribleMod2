...
public class TheVVizardEntity extends Monster implements RangedAttackMob {
	...
	public TheVVizardEntity(EntityType<TheVVizardEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("The VVizard"));
		setCustomNameVisible(true);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(TerribletwoModItems.LEAN_BUCKET.get()));
		this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(TerribletwoModItems.COSMIC_KUSH.get()));
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("terribletwo:wizardhurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("terribletwo:vvizarddeathtemp"));
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
		...
		TheVVizardOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ());
		return retval;
	}

	@Override
	public void performRangedAttack(LivingEntity target, float flval) {
		TheVVizardEntityProjectile entityarrow = new TheVVizardEntityProjectile(TerribletwoModEntities.THE_V_VIZARD_PROJECTILE.get(), this, this.level());
