...
public class NapoleonicSoldierLTGEntity extends Monster implements RangedAttackMob {
	public NapoleonicSoldierLTGEntity(EntityType<NapoleonicSoldierLTGEntity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(TerribletwoModItems.MUSKET.get()));
	}
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("terribletwo:soldierlines"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("terribletwo:soldierhit"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("terribletwo:soldierdeath"));
	}
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		MusketBallEntity.shoot(this, target);
	}

	public static void init(SpawnPlacementRegisterEvent event) {
		event.register(TerribletwoModEntities.NAPOLEONIC_SOLDIER_LTG.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
