...
import net.mcreator.terribletwo.procedures.GojoOnInitialEntitySpawnProcedure;
import net.mcreator.terribletwo.procedures.GojoEntityDiesProcedure;
import net.mcreator.terribletwo.init.TerribletwoModItems;

import javax.annotation.Nullable;

public class GojoEntity extends Monster implements RangedAttackMob {
	...
	public void die(DamageSource source) {
		super.die(source);
		GojoEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}

	@Override
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
		SpawnGroupData retval = super.finalizeSpawn(world, difficulty, reason, livingdata);
		GojoOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ());
		return retval;
	}
