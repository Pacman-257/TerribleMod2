...
public class TheYellowWizardEntity extends Monster implements RangedAttackMob {
	public TheYellowWizardEntity(EntityType<TheYellowWizardEntity> type, Level world) {
		super(type, world);
		xpReward = 15;
		setNoAi(false);
