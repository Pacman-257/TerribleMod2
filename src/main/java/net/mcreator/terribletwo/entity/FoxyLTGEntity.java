...
public class FoxyLTGEntity extends Monster implements RangedAttackMob {
	public FoxyLTGEntity(EntityType<FoxyLTGEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		JumpscareFoxyEntity.shoot(this, target);
	}
