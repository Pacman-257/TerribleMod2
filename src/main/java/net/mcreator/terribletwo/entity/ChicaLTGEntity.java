...
public class ChicaLTGEntity extends Monster implements RangedAttackMob {
	public ChicaLTGEntity(EntityType<ChicaLTGEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		JumpscareChicaEntity.shoot(this, target);
	}
