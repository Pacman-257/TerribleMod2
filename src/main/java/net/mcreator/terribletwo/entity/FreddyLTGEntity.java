...
public class FreddyLTGEntity extends Monster implements RangedAttackMob {
	public FreddyLTGEntity(EntityType<FreddyLTGEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		JumpscareFreddyEntity.shoot(this, target);
	}
