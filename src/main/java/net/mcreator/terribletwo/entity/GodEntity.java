...
import net.mcreator.terribletwo.procedures.GodOnInitialEntitySpawnProcedure;
import net.mcreator.terribletwo.procedures.GodEntityDiesProcedure;
import net.mcreator.terribletwo.init.TerribletwoModItems;

import javax.annotation.Nullable;

public class GodEntity extends Monster implements RangedAttackMob {
	...
	public void die(DamageSource source) {
		super.die(source);
		GodEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}

	@Override
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
		SpawnGroupData retval = super.finalizeSpawn(world, difficulty, reason, livingdata);
		GodOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ());
		return retval;
	}
