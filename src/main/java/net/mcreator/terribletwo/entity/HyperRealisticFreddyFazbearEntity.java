...
public class HyperRealisticFreddyFazbearEntity extends Monster implements RangedAttackMob {
	...
	public HyperRealisticFreddyFazbearEntity(EntityType<HyperRealisticFreddyFazbearEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		HyperRealisticFreddyFazbearEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}

	@Override
	public void performRangedAttack(LivingEntity target, float flval) {
		HRFJumpscareEntity.shoot(this, target);
	}
