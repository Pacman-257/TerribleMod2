...
import net.mcreator.terribletwo.procedures.GoldenFreddyEntityDiesProcedure;
import net.mcreator.terribletwo.init.TerribletwoModItems;

public class GoldenFreddyEntity extends Monster implements RangedAttackMob {
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TerribletwoModItems.PINEAPPLE_PIZZA.get()));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		GoldenFreddyEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}

	@Override
	public void performRangedAttack(LivingEntity target, float flval) {
		GoldenJumpscareEntity.shoot(this, target);
	}
