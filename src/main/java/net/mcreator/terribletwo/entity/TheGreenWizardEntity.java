...
public class TheGreenWizardEntity extends Monster implements RangedAttackMob {
	public TheGreenWizardEntity(EntityType<TheGreenWizardEntity> type, Level world) {
		super(type, world);
		xpReward = 15;
		setNoAi(false);
