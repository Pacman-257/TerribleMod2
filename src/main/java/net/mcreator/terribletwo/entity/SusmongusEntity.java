...
import net.mcreator.terribletwo.procedures.SusmongusRightClickedOnEntityProcedure;
...
public class SusmongusEntity extends TamableAnimal {
	public SusmongusEntity(EntityType<SusmongusEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new TemptGoal(this, 1, Ingredient.of(TerribletwoModItems.GODS_SHOES_BOOTS.get()), false));
		this.goalSelector.addGoal(5, new LookAtPlayerGoal(this, GodEntity.class, (float) 24));
		this.goalSelector.addGoal(6, new TemptGoal(this, 1, Ingredient.of(TerribletwoModItems.COSMIC_SPLIFF.get()), false));
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		SusmongusRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SusmongusEntity retval = TerribletwoModEntities.SUSMONGUS.get().create(serverWorld);
