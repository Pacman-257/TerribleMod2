...
public class KanyeWestEntity extends Monster {
	public KanyeWestEntity(EntityType<KanyeWestEntity> type, Level world) {
		super(type, world);
		xpReward = 100;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TerribletwoModItems.SPEAROF_LONSUSIS.get()));
	}
